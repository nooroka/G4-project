...
b_pattern         = "../../../punkt1/stage2/merged_no_flanks/quadr7_chain180424_merged2_sorted_{}_{}_no_flanks.bed"
gccoords_pattern  = "../gccoords2/def/gccoords_{}2defhg19_40_all_loop7_control2_no_gc_corrected.bed.gz"
...
out_file = "results100826/results_no_flanks_{}_control2.tsv".format(sys.argv[1])

with open(out_file, "w") as w:
    w.write("chr\tgccoords_len\tb_len\tmut_on_gc\tmut_on_b\tdensity_control\tdensity_quadr\n")
    for i in range(1, 25):
        gc_file  = gccoords_pattern.format(i)
