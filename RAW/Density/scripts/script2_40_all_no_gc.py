...
cmd1 = (
    ...
    """resultgenehg19{c}_40_all_loop7_control2_no_gc.bed"""
...
w3 = open(
    ...
    "gccoords_{}2defhg19_40_all_loop7_control2_no_gc_2.bed".format(sys.argv[3]),
    "w"
)
a = ""
for line in op:
...
os.system(
    ...
    "| awk '!seen[$4]++' "
    "> /data/nooroka/grant/punkt3/stage2/resultgene/"
    "resultgenehg19{c}_un_40_all_loop7_control2_no_gc.bed".format(c=sys.argv[3])
)

# ── 3g Второй bedtools: мутации × GC-координаты ─────────────────────────────
...
intmut_out = (
    ...
    "intmuthg19{c}_40_all_loop7_control2_no_gc.bed".format(c=sys.argv[3])
)
...
bed_a_inner = (
    "zcat /data/nooroka/grant/punkt3/bed-37/bed_chr_{c}_sorted.bed.gz | "
    "awk 'BEGIN{{OFS=\"\\t\"}} {{ if ($3 <= $2) $3=$2+1; print }}'"
).format(c=sys.argv[3])
gccoords_2def = "/data/nooroka/grant/punkt3/stage2/gccoords/def/gccoords_{c}2defhg19_40_all_loop7_control2_no_gc_2.bed".format(c=sys.argv[3])
...
d2 = count_lines_fast(
    "/data/nooroka/grant/punkt3/stage2/resultgene/"
    "resultgenehg19{}_un_40_all_loop7_control2_no_gc.bed".format(sys.argv[3])
)
...
raw = intmut_out+".raw"
d1  = count_lines_fast(raw)   # = d11 в оригинале
os.remove(intmut_out + ".raw")
