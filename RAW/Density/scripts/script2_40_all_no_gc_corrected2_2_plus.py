...
paths = {
    "gccoords": f"{BASE}/gccoords/def/gccoords_{CHR}2defhg19_40_all_loop7_control2_no_gc_plus_corrected2.bed",
    "intmut":   f"{BASE}/intmut/intmuthg19{CHR}_40_all_loop7_control2_no_gc_plus_corrected2.bed",
    "res_raw":  f"{BASE}/resultgene/resultgenehg19{CHR}_40_all_loop7_control2_no_gc_plus_corrected2.bed",
    "res_uniq": f"{BASE}/resultgene/resultgenehg19{CHR}_un_40_all_loop7_control2_no_gc_plus_corrected2.bed",
}
