...
d2 =count_lines_fast('/data/nooroka/grant/punkt3/stage2/resultgene/resultgenehg19{}_un_39_all_loop7_control2.bed'.format(sys.argv[3]))
for line2 in op2:
       # d2 +=1
        line2 = line2.strip()
        line2 = line2.split()
...
g1 =count_lines_fast('/data/nooroka/grant/punkt3/stage2/intmut/intmuthg19{}_39_all_loop7_control2.bed'.format(sys.argv[3]))
d11 = d1
