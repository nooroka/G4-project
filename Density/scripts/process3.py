...
def remove_cg_overlapping(sequence, start_position):
    ...
    while i < len(sequence):
        ...
        if match:
            removed_positions.append(start_position + i)
            i += 2
        else:
...
if __name__ == "__main__":
    ...
    output_file = "../../cleaned_genome3.fasta"  # Файл для очищенной последовательности
    bed_file = "../../removed_cg_coordinates3.bed"  # Файл для координат удалённых CG
    chrom_sizes_file = "../../hg19.chrom3.sizes"  # Файл с размерами хромосом
    subtracted_bed_file = "../../subtracted_regions3.bed"  # Файл для результата вычитания
