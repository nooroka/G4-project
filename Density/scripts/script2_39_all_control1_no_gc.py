...
cmd1 = (
    ...
    """resultgenehg19{c}_39_all_loop7_control1_no_gc.bed"""
...
w3 = open(
    ...
    "gccoords_{}2defhg19_39_all_loop7_control1_no_gc.bed".format(sys.argv[3]),
    "w"
)
a = ""
for line in op:
...
os.system(
    ...
    "gccoords_{c}2defhg19_39_all_loop7_control1_no_gc.bed "
    "| awk '!seen[$1,$2,$3]++' "
    "> /data/nooroka/grant/punkt3/stage2/gccoords/def/"
    "gccoords_{c}_undefhg19_39_all_loop7_control1_no_gc.bed".format(c=sys.argv[3])
)
...
os.system(
    ...
    "| awk '!seen[$4]++' "
    "> /data/nooroka/grant/punkt3/stage2/resultgene/"
    "resultgenehg19{c}_un_39_all_loop7_control1_no_gc.bed".format(c=sys.argv[3])
)
...
intmut_out = (
    ...
    "intmuthg19{c}_39_all_loop7_control1_no_gc.bed".format(c=sys.argv[3])
)
...
d2 = count_lines_fast(
    "/data/nooroka/grant/punkt3/stage2/resultgene/"
    "resultgenehg19{}_un_39_all_loop7_control1_no_gc.bed".format(sys.argv[3])
)
