...
"""resultgenehg19{c}_39_all_loop7_control2_no_gc_corrected.bed"""
...
w3 = open(
    ...
    "gccoords_{}2defhg19_39_all_loop7_control2_no_gc_corrected.bed".format(sys.argv[3]),
    "w"
)
a = ""
sum_control1 =0
...
os.system(
    ...
    "| awk '!seen[$4]++' "
    "> /data/nooroka/grant/punkt3/stage2/resultgene/"
    "resultgenehg19{c}_un_39_all_loop7_control2_no_gc_corrected.bed".format(c=sys.argv[3])
)
...
gccoords_2def = (
    "/data/nooroka/grant/punkt3/stage2/gccoords/def/"
    "gccoords_{c}2defhg19_39_all_loop7_control2_no_gc_corrected.bed".format(c=sys.argv[3])
)
intmut_out = (
    "/data/nooroka/grant/punkt3/stage2/intmut/"
    "intmuthg19{c}_39_all_loop7_control2_no_gc_corrected.bed".format(c=sys.argv[3])
)
...
d2 = count_lines_fast(
    "/data/nooroka/grant/punkt3/stage2/resultgene/"
    "resultgenehg19{}_un_39_all_loop7_control2_no_gc_corrected.bed".format(sys.argv[3])
)
