...
w3 = open(
    "/data/nooroka/grant/punkt3/stage2/gccoords/def/gccoords_new_{}2defgenes_less_50_control_40.bed".format(sys.argv[2]),
    "w"
)
...
cmd = (
    ...
    "-b /data/nooroka/grant/punkt3/stage2/gccoords/def/gccoords_new_{0}2defgenes_less_50_control_40.bed "
    "-wa -wb | awk '!seen[$4]++' "
    "> /data/nooroka/grant/punkt3/stage2/intmut/intmuthg19{0}_genome_control_genes_40.bed"
).format(sys.argv[2])

subprocess.run(cmd, shell=True, executable="/bin/bash")

d1 = count_lines_fast(
    '/data/nooroka/grant/punkt3/stage2/intmut/intmuthg19{}_genome_control_genes_40.bed'.format(sys.argv[2])
)
d11 = d1
