...
if __name__ == "__main__":
    ...
    output_file = "../../cleaned_genome4.fasta"  # Файл для очищенной последовательности
    bed_file = "../../removed_cg_coordinates4.bed"  # Файл для координат удалённых CG
    chrom_sizes_file = "../../hg19.chrom4.sizes"  # Файл с размерами хромосом
    subtracted_bed_file = "../../subtracted_regions4.bed"  # Файл для результата вычитания
